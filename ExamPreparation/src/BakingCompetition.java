    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < numberOfBakers; i++) {
            ...
            while (!typeOfSweets.equals("Stop baking!")) {
                ...
                switch (typeOfSweets) {
                    case "cookies":
                        ...
                        moneyGained += numberOfSweets * 1.50;

                        break;

                    case "cakes":
                        cakes += numberOfSweets;
                        moneyGained += numberOfSweets * 7.80;

                        break;

                    case "waffles":
                        waffles += numberOfSweets;
                        moneyGained += numberOfSweets * 2.30;
            ...
            System.out.printf("%s baked %d cookies, %d cakes and %d waffles.%n",
                    name, cookies, cakes, waffles);
        }

        System.out.printf("All bakery sold: %d\n", totalSweets);
        System.out.printf("Total sum for charity: %.2f lv.", moneyGained);
    }
}
